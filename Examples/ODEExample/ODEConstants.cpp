...
const int ODEConstants::max_iterations = 50;
const sp_scalar ODEConstants::epsilon = 1e-12;

const sp_scalar ODEConstants::T = 1;
const sp_scalar ODEConstants::dt = 0.1;

const std::string ODEConstants::example = "Example1"; //"Example1" or "Example2"
